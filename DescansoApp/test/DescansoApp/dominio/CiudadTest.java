...
public class CiudadTest {
    ...
    public void testGetInfoGral() {
        final Ciudad instance = new Ciudad();
        instance.setInfoGral("Informacion");
    ...
    public void testAgregarImagen() {
        ...
        assertEquals("testAgregarImagen", expResult, result[1]);
    }
    ...
    public void testSetMapa() {
        final String mapa = "/descansoApp/imagenes/mapaaa.jpg";
        final Ciudad instance = new Ciudad();
        instance.setMapa(mapa);
        final String expResult = "imagenes/mapaaa.jpg";
        final String aux = instance.getMapa().toString();
        final String[] result = aux.toLowerCase().split("/descansoapp/descansoapp/");
        assertEquals("testGetMapa", expResult, result[1]);
    }
