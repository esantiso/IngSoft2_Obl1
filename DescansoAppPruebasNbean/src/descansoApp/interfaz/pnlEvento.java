...
class pnlEvento extends javax.swing.JPanel {
    ...
    public pnlEvento(final Sistema unModelo, final Viaje unViaje, final descansoApp.dominio.Ciudad unaCiudad, final descansoApp.dominio.ComercioActividad comercioActividad, final Evento unEvento, final JFrame unContenedor) {
        initComponents();
        modelo = unModelo;
        viaje = unViaje;
        modEvento = unEvento;
