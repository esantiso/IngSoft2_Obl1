...
class pResultadoDondeQue extends javax.swing.JPanel {
    ...
    public pResultadoDondeQue(final Sistema unModelo, final ComercioActividad unCA,  final JFrame unaVentana, final JPanel unPadre, final descansoApp.dominio.Ciudad unaCiudad) {
        initComponents();
